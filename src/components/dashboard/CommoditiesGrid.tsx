    ...
    <div className="h-full flex flex-col p-2.5 gap-1.5">
      ...
      <div className="flex items-center justify-between px-1">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-bold text-orange-400/90 tracking-widest uppercase">Komoditas</span>
      ...
      <div className="flex-1 grid grid-cols-3 grid-rows-2 gap-1.5 min-h-0">
        {data.map(item => {
          ...
          return (
            <div key={item.symbol} className="rounded-lg border border-zinc-800/20 bg-zinc-900/20 px-2 py-1.5 flex flex-col justify-between hover:bg-zinc-800/20 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  <span className="text-xs">{icon}</span>
                  <div>
                    <span className="text-[9px] font-bold text-zinc-400 tracking-wide">{item.name}</span>
                    <span className="text-[7px] text-zinc-700 block">{item.unit}</span>
                  </div>
                </div>
              </div>
              <div className="flex items-end justify-between mt-1">
                <span className={`font-mono text-[11px] font-semibold ${color} tabular-nums`}>
